...
//        throw new NotSupportedException('"findIdentityByAccessToken" is not implemented.');
     ...
     * @return \mdm\admin\models\User|null
     */
    public static function findByUsername($username)
    {
//        return static::findOne(['username' => $username, 'status' => UserStatus::ACTIVE]);
        return self::find()->andWhere(['username'=>$username,  'status' => UserStatus::ACTIVE])->one();
    }
    ...
    public static function findByPasswordResetToken($token)
    {
        ...
        return self::find()->andWhere(['password_reset_token'=>$token])->one();
